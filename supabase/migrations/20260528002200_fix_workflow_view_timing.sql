-- Fix v_episode_workflow: post-shoot followup due date corrected to shoot_date + 1 day
...
SELECT
  ...
  e.youtube_scheduled_publish_at,
  e.rumble_url,
  e.podcast_url,

  -- Computed email due dates
  e.shoot_date                                    AS zoom_link_due,
  e.shoot_date + interval '1 day'                AS post_shoot_followup_due,
