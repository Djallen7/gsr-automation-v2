...
- **SYSTEM-EVOLUTION.md** contains outdated Tailscale restriction language throughout. It is superseded on these points by this canon (sections 13-14). A full doc-pass to correct SYSTEM-EVOLUTION is needed but not blocking.

## 14. Infrastructure restriction updates (Daniel, 2026-06-11)
