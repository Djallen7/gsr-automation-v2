...
GRAPHICS_DATA = [
    ...
    ("Ministry report intro",     "EP021", "Ministry Report",     5, "Title Graphic",        "Done",       "Miriam",   1, ""),
    ("Viewer voice quote card",   "EP021", "Viewer Voices",       6, "Propres Quote",        "Done",       "Isaac",    1, ""),
    ("Resource book cover",       "EP021", "Featured Resource",   7, "Picture",              "Done",       "Miriam",   1, ""),
    ...
    ("Ministry highlights reel",  "EP022", "Ministry Report",     5, "Clip w/audio",         "Done",       "Miriam",   2, "30 sec max"),
    ...
    ("Resource thumbnail",        "EP023", "Featured Resource",   7, "Picture",              "In Progress","Miriam",   3, "Awaiting book art"),
    ("Ministry reel",             "EP023", "Ministry Report",     8, "Clip w/audio",         "Loaded In",  "Miriam",   3, ""),
    ...
    ("Ministry highlight clip",   "EP024", "Ministry Report",     7, "Clip w/audio",         "Not Started","Miriam",   4, ""),
    ("Viewer voices quote",       "EP024", "Viewer Voices",       8, "Propres Quote",        "Not Started","Isaac",    4, ""),
    ("Featured resource image",   "EP024", "Featured Resource",   9, "Picture",              "Not Started","Miriam",   4, ""),
    ...
    ("Ministry report title",     "EP025", "Ministry Report",     5, "Title Graphic",        "Not Started","Miriam",   5, ""),
    ("Viewer voices quote",       "EP025", "Viewer Voices",       6, "Propres Quote",        "Not Started","Isaac",    5, ""),
    ("Featured resource",         "EP025", "Featured Resource",   7, "Picture",              "Not Started","Miriam",   5, ""),
