...
**Supabase project:** `lafkbxypmciopebentxp` — 20 tables, 45 migrations, 2 enums, 2 views, 3 functions, 3 triggers, 1 storage bucket (`lower-thirds`). Rows: episodes 48, guests 175, **graphics 0** (no live import yet — the real Stage 7 milestone, an operational step not a code defect).
